...
from evals.intuitive_physics.videomae import Block, PatchEmbed, get_sinusoid_encoding_table, _cfg
...
class PretrainVisionTransformer(nn.Module):
    ...
    def extract_assignments(self, projected_features, detach=False):
        ...
        batch_q = find_optimal_assignment(batch_scores, self.eps, self.sinkhorn_iterations, world_size=self.world_size)
