# Code adapted from https://github.com/MCG-NJU/VideoMAE/blob/main/modeling_pretrain.py
...
class PretrainVisionTransformerDecoder(nn.Module):
    ...
    def forward(self, x, return_token_num,return_block=-1):
        if self.use_checkpoint:
...
class PretrainVisionTransformer(nn.Module):
    ...
    def forward(self, x, mask, decoder_blocks=-1):
        _, _, T, _, _ = x.shape
        ...
        x = self.decoder(x_full, pos_emd_mask.shape[1],return_block=decoder_blocks) # [B, N_mask, 3 * 16 * 16]
